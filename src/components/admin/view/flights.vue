...
<!--            相关城市 -->
          ...
          <a-button-group>
            ...
            <a-button type="primary" >
              <router-link to="addCity">新增航班</router-link>
            </a-button>
          </a-button-group>
        </div>
      </template>
      ...
      >
        ...
        <template class="flex justify-center" slot="operation" slot-scope="text,record">
          <a-button @click="editCity(text,record)" type="primary">编辑航线</a-button>
        </template>
      </a-table>
    </table-layout>
    <!--    弹窗组件,弹窗修改城市信息 -->
          ...
          <a-row class="mt-10">
            ...
            <a-col>
              <a-button-group>
                ...
                <a-button type="primary" @click="submitHandle">修改航班信息</a-button>
              </a-button-group>
            </a-col>
          </a-row>
...
export default {
  ...
  computed:{
    ...mapState({
      flightColumn: state=>state.flights[types.flights.state.cityTableColumns],
      // 国内城市
      flights: state=>state.citys[types.citys.state.domestic],
      // 国际城市
